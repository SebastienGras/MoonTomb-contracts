...
contract Treasury is ContractGuard {
    ...
    address[] public excludedFromTotalSupply = [
        address(0x12D7485d84f3B82DB6B245450530Ada015fe19aa) // BombGenesisPool
        // address(0x2878Ac693A52517a43b6D68B11f8Aae217c45F2b) // new BombRewardPool
    ];
    ...
    function initialize(
        ...
        bombPriceOne = 10**18; // This is to allow a PEG of 10,000 BOMB per BTC
