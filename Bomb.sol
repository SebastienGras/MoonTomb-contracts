...
contract Bomb is ERC20Burnable, Operator {
    ...
    // uint256 public constant INITIAL_BOMB_POOL_DISTRIBUTION = 0 ether;
     ...
     */
    constructor(uint256 _taxRate, address _taxCollectorAddress) public ERC20("MoonTomb Finance", "MOONTOMB") {
